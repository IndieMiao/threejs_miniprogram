...
function initEnvMap()
{
    ...
    environmentMap = cubeTextureLoader.load(
        [
            '/textures/hdr6/px.png',
            '/textures/hdr6/nx.png',
            '/textures/hdr6/py.png',
            '/textures/hdr6/ny.png',
            '/textures/hdr6/pz.png',
            '/textures/hdr6/nz.png'
        ]
    )
}
